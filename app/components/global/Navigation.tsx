...
export default function Navigation() {
  return (
    <nav 
    className="flex justify-between w-screen sticky top-0 left-0 right-0 z-50 h-24 bg-black/90 border-b border-t border-pink">
      <svg 
      ...
      <div 
      className="flex items-center justify-between w-screen px-6">
